...
This is a condensed reference of the most common violations to check during implementation. For the full checklist, see `skills/om-code-review/references/review-checklist.md`.
